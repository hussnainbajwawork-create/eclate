                  ...
                  <div className="border-t border-border/60 px-5 py-5 animate-fade-in">
                      ...
                      <div className="mt-5 border border-border/60 bg-secondary/20 p-5">
                        ...
                        <div className="mt-3 grid gap-4 md:grid-cols-2">
                          <dl className="space-y-2 text-sm">
                            ...
                            <div className="flex gap-2"><dt className="text-muted-foreground">Amount Paid:</dt><dd className="font-serif">{formatPKR(payment.amount)}</dd></div>
                            <div className="flex gap-2"><dt className="text-muted-foreground">Order Total:</dt><dd className="font-serif text-accent">{formatPKR(o.total)}</dd></div>
                    ...
                    {!payment && o.status === "pending" && (
                      <div className="mt-5 flex items-center gap-3 border border-amber-300/50 bg-amber-50 px-5 py-3 text-sm dark:border-amber-700/50 dark:bg-amber-900/20">
                        ...
                        <span>{o.notes?.includes("Cash on Delivery") ? "Order placed via Cash on Delivery." : "Awaiting online payment proof from customer."}</span>
                      </div>
                    )}
